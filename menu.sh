...
# === FILE: menu.sh (Instalasi Otomatis dengan Log) ===
...
ExecStart=/bin/bash -c "
    ...
    sleep 2
    google-chrome --no-sandbox --disable-gpu --disable-dev-shm-usage --force-device-scale-factor=0.8 --window-size=800,400 &
"
Restart=always
